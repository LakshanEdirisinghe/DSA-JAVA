...
public class BSTree {
    public static void main(String[] args) {
        ...
        binarySearchTree.insert("B", 15);
        binarySearchTree.insert("C", 20);
        binarySearchTree.insert("D", 25);
        binarySearchTree.insert("E", 30);
        binarySearchTree.insert("F", 35);
        binarySearchTree.insert("G", 40);
